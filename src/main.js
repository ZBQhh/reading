...
import {
  applyFontScale, loadPage, switchIssue, enterReaderRoom, openLibraryShelf, isManualIssue,
  resolveIssue,
...
function bindStaticEvents() {
  ...
  // 期刊切换下拉菜单相关函数已提升至模块级（供模块级 handleGlobalKeyDown 的 M 键调用），见本文件底部。
...
// 提升至模块级：模块级 handleGlobalKeyDown 的 M 键需要调用 openIssueSwitcher
